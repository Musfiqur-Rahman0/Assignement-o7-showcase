...
const Navbar = ({ bidProducts }) => {
  return (
    <nav className=" font-poppins px-3 md:px-0 md:w-10/12 mx-auto flex items-center py-5  justify-between">
      <Logo />
      <Page />
      <div className="flex items-center gap-3">
        ...
        <div className="hidden md:block relative p-3 bg-[#EBF0F5] rounded-full">
